...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Occurrence.start_datetime'
        db.add_column('events_occurrence', 'start_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 10, 4, 1, 34, 14, 442998)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Occurrence.start_datetime'
        db.delete_column('events_occurrence', 'start_datetime')
