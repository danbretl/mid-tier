...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.category_type'
        db.add_column('events_category', 'category_type', self.gf('django.db.models.fields.CharField')(default='O', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.category_type'
        db.delete_column('events_category', 'category_type')
