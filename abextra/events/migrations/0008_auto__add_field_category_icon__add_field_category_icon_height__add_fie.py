...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_category', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Category.icon_height'
        db.add_column('events_category', 'icon_height', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Category.icon_width'
        db.add_column('events_category', 'icon_width', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.icon'
        db.delete_column('events_category', 'icon')

        # Deleting field 'Category.icon_height'
        db.delete_column('events_category', 'icon_height')

        # Deleting field 'Category.icon_width'
        db.delete_column('events_category', 'icon_width')
    ...
    models = {
        ...
        'events.eventtime': {
            ...
            'occurrence': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_times'", 'to': "orm['events.Occurrence']"}),
