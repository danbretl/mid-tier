...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Occurrence', fields ['start_time', 'place', 'event', 'start_date']
        db.create_unique('events_occurrence', ['start_time', 'place_id', 'event_id', 'start_date'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Occurrence', fields ['start_time', 'place', 'event', 'start_date']
        db.delete_unique('events_occurrence', ['start_time', 'place_id', 'event_id', 'start_date'])
    ...
    models = {
        ...
        'events.occurrence': {
            'Meta': {'unique_together': "(('event', 'place', 'start_date', 'start_time'),)", 'object_name': 'Occurrence'},
