...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('events_eventsummary', 'id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'EventSummary.id'
        raise RuntimeError("Cannot reverse this migration. 'EventSummary.id' and its values cannot be restored.")
