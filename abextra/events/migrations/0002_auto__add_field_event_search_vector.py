...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.search_vector'
        db.add_column('events_event', 'search_vector', self.gf('core.fields.VectorField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.search_vector'
        db.delete_column('events_event', 'search_vector')
    ...
    models = {
        ...
        'events.event': {
            ...
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'4293a9ff03'", 'max_length': '10', 'blank': 'True'}),
