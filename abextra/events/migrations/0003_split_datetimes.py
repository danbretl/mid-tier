...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for event_time in orm.EventTime.objects.all():
            event_time.start_date = event_time.start.date()
            event_time.start_time = event_time.start.time()
            event_time.end_date = event_time.end.date()
            event_time.end_time = event_time.end.time()
            event_time.save()
