...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventSummary.concrete_category'
        db.add_column('events_eventsummary', 'concrete_category', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='event_summaries', to=orm['events.Category']), keep_default=False)

        # Adding field 'EventSummary.concrete_parent_category'
        db.add_column('events_eventsummary', 'concrete_parent_category', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['events.Category']), keep_default=False)
