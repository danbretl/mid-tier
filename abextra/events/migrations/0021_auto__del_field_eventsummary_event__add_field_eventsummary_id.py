...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('events_eventsummary', 'event', self.gf('django.db.models.fields.related.OneToOneField')(default=0, related_name='summary', unique=True, primary_key=True, to=orm['events.Event']), keep_default=False)
    ...
    models = {
        ...
        'events.eventsummary': {
            ...
            'id': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'summary'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['events.Event']"}),
