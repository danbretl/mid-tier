...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EventSummary.id'
        db.alter_column('events_eventsummary', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
    ...
    models = {
        ...
        'events.eventsummary': {
            ...
            'id': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['events.Event']", 'unique': 'True', 'primary_key': 'True'}),
