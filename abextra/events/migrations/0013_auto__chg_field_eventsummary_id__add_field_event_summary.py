...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'EventSummary.id' to match new field type.
        db.rename_column('events_eventsummary', 'id_id', 'id')
        # Changing field 'EventSummary.id'
        db.alter_column('events_eventsummary', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Removing index on 'EventSummary', fields ['id']
        db.delete_index('events_eventsummary', ['id_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding index on 'EventSummary', fields ['id']
        db.create_index('events_eventsummary', ['id_id'])

        # Renaming column for 'EventSummary.id' to match new field type.
        db.rename_column('events_eventsummary', 'id', 'id_id')
        # Changing field 'EventSummary.id'
        db.alter_column('events_eventsummary', 'id_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['events.Event'], unique=True, primary_key=True))
    ...
    models = {
        ...
        'events.event': {
            ...
            'summary': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['events.EventSummary']", 'unique': 'True', 'null': 'True'}),
        ...
        'events.eventsummary': {
            ...
            'date_range': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'place': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'price_range': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
            'time': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'events.occurrence': {
