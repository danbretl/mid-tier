...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventTime.occurrence'
        db.add_column('events_eventtime', 'occurrence', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Occurrence'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EventTime.occurrence'
        db.delete_column('events_eventtime', 'occurrence_id')
    ...
    models = {
        ...
        'events.eventtime': {
            ...
            'occurrence': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['events.Occurrence']", 'null': 'True', 'blank': 'True'}),
