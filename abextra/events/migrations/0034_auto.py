...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field external_categories on 'Event'
        db.create_table('events_event_external_categories', (
        ...
        db.create_unique('events_event_external_categories', ['event_id', 'externalcategory_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field external_categories on 'Event'
        db.delete_table('events_event_external_categories')
    ...
    models = {
        ...
        'events.event': {
            ...
            'external_categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['importer.ExternalCategory']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'secret_key': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
