...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Occurrence', fields ['start_datetime']
        db.create_index('events_occurrence', ['start_datetime'])


    def backwards(self, orm):
        
        # Removing index on 'Occurrence', fields ['start_datetime']
        db.delete_index('events_occurrence', ['start_datetime'])
