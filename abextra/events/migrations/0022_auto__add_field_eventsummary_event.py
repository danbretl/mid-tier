...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_eventsummary', 'event', self.gf('django.db.models.fields.related.OneToOneField')(default=2, to=orm['events.Event'], unique=True), keep_default=False)
