...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute("create FULLTEXT index titlesearch ON abexmid.events_event(title);")
        print "Created the title fulltext index..."

    def backwards(self, orm):
        db.execute("ALTER TABLE abexmid.events_event DROP INDEX titlesearch")
        print "Deleted the title fulltext index..."
