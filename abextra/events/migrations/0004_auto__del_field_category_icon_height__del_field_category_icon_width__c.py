...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('events_category', 'icon', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Category.icon'
        db.alter_column('events_category', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
