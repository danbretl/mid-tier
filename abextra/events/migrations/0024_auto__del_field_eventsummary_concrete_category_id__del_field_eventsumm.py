...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'EventSummary.concrete_category_id'
        raise RuntimeError("Cannot reverse this migration. 'EventSummary.concrete_category_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EventSummary.concrete_parent_category_id'
        raise RuntimeError("Cannot reverse this migration. 'EventSummary.concrete_parent_category_id' and its values cannot be restored.")
