...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.concrete_category'
        db.add_column('events_event', 'concrete_category', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events_concrete', null=True, to=orm['events.Category']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.concrete_category'
        db.delete_column('events_event', 'concrete_category_id')
