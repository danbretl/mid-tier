...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.popularity_score'
        db.add_column('events_event', 'popularity_score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.popularity_score'
        db.delete_column('events_event', 'popularity_score')
