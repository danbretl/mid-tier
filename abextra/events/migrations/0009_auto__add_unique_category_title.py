...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Category', fields ['title']
        db.create_unique('events_category', ['title'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Category', fields ['title']
        db.delete_unique('events_category', ['title'])
