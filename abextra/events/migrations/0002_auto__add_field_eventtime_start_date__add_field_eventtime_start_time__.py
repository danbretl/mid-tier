...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventTime.start_date'
        db.add_column('events_eventtime', 'start_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'EventTime.start_time'
        db.add_column('events_eventtime', 'start_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'EventTime.end_date'
        db.add_column('events_eventtime', 'end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'EventTime.end_time'
        db.add_column('events_eventtime', 'end_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventTime.start_date'
        db.delete_column('events_eventtime', 'start_date')

        # Deleting field 'EventTime.start_time'
        db.delete_column('events_eventtime', 'start_time')

        # Deleting field 'EventTime.end_date'
        db.delete_column('events_eventtime', 'end_date')

        # Deleting field 'EventTime.end_time'
        db.delete_column('events_eventtime', 'end_time')
