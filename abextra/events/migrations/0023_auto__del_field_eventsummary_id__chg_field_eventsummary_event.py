...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EventSummary.id'
        db.delete_column('events_eventsummary', 'id_id')

        # Changing field 'EventSummary.event'
        db.alter_column('events_eventsummary', 'event_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, to=orm['events.Event']))


    def backwards(self, orm):
        
        # Adding field 'EventSummary.id'
        db.add_column('events_eventsummary', 'id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, related_name='summary', unique=True, primary_key=True, to=orm['events.Event']), keep_default=False)

        # Changing field 'EventSummary.event'
        db.alter_column('events_eventsummary', 'event_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['events.Event'], unique=True))
    ...
    models = {
        ...
        'events.eventsummary': {
            ...
            'concrete_category_id': ('django.db.models.fields.IntegerField', [], {}),
            'concrete_parent_category_id': ('django.db.models.fields.IntegerField', [], {}),
