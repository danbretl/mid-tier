...
class Migration(SchemaMigration):
    ...
    def _reflect(self, orm):
        ...
        table = meta.db_table
        search_vector_field = meta.get_field('search_vector')
        search_vector_column = search_vector_field.column or \
            search_vector_field.db_column
        index_name = '_'.join((table, search_vector_column, 'idx'))
        return table, search_vector_column, index_name
    ...
    models = {
        ...
        'events.event': {
            ...
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'e7bb69f94b'", 'max_length': '10', 'blank': 'True'}),
