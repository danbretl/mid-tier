...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EventTime.start'
        db.delete_column('events_eventtime', 'start')

        # Deleting field 'EventTime.end'
        db.delete_column('events_eventtime', 'end')

        # Changing field 'EventTime.start_date'
        db.alter_column('events_eventtime', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(1, 1, 1)))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'EventTime.start'
        raise RuntimeError("Cannot reverse this migration. 'EventTime.start' and its values cannot be restored.")

        # Adding field 'EventTime.end'
        db.add_column('events_eventtime', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Changing field 'EventTime.start_date'
        db.alter_column('events_eventtime', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))
