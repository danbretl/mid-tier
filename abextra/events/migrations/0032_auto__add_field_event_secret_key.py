...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.secret_key'
        db.add_column('events_event', 'secret_key', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.secret_key'
        db.delete_column('events_event', 'secret_key')
