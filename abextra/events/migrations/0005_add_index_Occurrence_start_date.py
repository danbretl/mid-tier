...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Occurrence', fields ['start_date']
        db.create_index('events_occurrence', ['start_date'])


    def backwards(self, orm):
        
        # Removing index on 'Occurrence', fields ['start_date']
        db.delete_index('events_occurrence', ['start_date'])
