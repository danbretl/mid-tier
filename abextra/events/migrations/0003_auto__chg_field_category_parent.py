...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('categories', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Category']))


    def backwards(self, orm):
        
        # Changing field 'Category.parent'
        db.alter_column('categories', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['events.Category']))
