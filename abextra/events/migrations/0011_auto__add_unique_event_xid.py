...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Event', fields ['xid']
        db.create_unique('events_event', ['xid'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Event', fields ['xid']
        db.delete_unique('events_event', ['xid'])
    ...
    models = {
        ...
        'events.event': {
            ...
            'xid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200', 'blank': 'True'})
        },
        'events.eventsummary': {
