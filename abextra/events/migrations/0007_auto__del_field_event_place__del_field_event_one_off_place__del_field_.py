...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('events_event', 'place_id')

        # Deleting field 'Event.one_off_place'
        db.delete_column('events_event', 'one_off_place')

        # Deleting field 'EventTime.event'
        db.delete_column('events_eventtime', 'event_id')

        # Changing field 'EventTime.occurrence'
        db.alter_column('events_eventtime', 'occurrence_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['events.Occurrence']))


    def backwards(self, orm):
        
        # Adding field 'Event.place'
        db.add_column('events_event', 'place', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True, blank=True), keep_default=False)

        # Adding field 'Event.one_off_place'
        db.add_column('events_event', 'one_off_place', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'EventTime.event'
        raise RuntimeError("Cannot reverse this migration. 'EventTime.event' and its values cannot be restored.")

        # Changing field 'EventTime.occurrence'
        db.alter_column('events_eventtime', 'occurrence_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Occurrence'], null=True))
