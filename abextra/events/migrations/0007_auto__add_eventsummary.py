...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_eventsummary', (
            ...
            ('concrete_category', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('date_range', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('price_range', self.gf('django.db.models.fields.CharField')(max_length=25)),
        ))
