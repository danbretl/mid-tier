...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Occurrence', fields ['start_time']
        db.create_index('events_occurrence', ['start_time'])


    def backwards(self, orm):
        
        # Removing index on 'Occurrence', fields ['start_time']
        db.delete_index('events_occurrence', ['start_time'])
