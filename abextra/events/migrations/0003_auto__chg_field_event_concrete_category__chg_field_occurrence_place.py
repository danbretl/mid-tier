...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.concrete_category'
        db.alter_column('events_event', 'concrete_category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=135, to=orm['events.Category']))

        # Changing field 'Occurrence.place'
        db.alter_column('events_occurrence', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['places.Place']))


    def backwards(self, orm):
        
        # Changing field 'Event.concrete_category'
        db.alter_column('events_event', 'concrete_category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Category']))

        # Changing field 'Occurrence.place'
        db.alter_column('events_occurrence', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True))
