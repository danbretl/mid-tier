...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RegexCategory'
        db.create_table('importer_regexcategory', (
        ...
        db.send_create_signal('importer', ['RegexCategory'])
    ...
    def backwards(self, orm):
        ...
        db.create_table('importer_sourceregexcategory', (
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='source_regex_categories', null=True, to=orm['events.Category'], blank=True)),
            ('regex', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='source_regex_categories', to=orm['events.Source'])),
        ))
        ...
        # Deleting model 'RegexCategory'
        db.delete_table('importer_regexcategory')
