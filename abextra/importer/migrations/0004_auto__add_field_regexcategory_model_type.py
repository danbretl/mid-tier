...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegexCategory.model_type'
        db.add_column('importer_regexcategory', 'model_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegexCategory.model_type'
        db.delete_column('importer_regexcategory', 'model_type')
