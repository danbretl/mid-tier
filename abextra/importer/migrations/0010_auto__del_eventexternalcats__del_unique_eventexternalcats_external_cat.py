...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'EventExternalCats', fields ['external_category', 'event']
        db.delete_unique('importer_eventexternalcats', ['external_category_id', 'event_id'])

        # Deleting model 'EventExternalCats'
        db.delete_table('importer_eventexternalcats')


    def backwards(self, orm):
        
        # Adding model 'EventExternalCats'
        db.create_table('importer_eventexternalcats', (
            ('external_category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_external_cat', to=orm['importer.ExternalCategory'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_external_cat', to=orm['events.Event'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('importer', ['EventExternalCats'])

        # Adding unique constraint on 'EventExternalCats', fields ['external_category', 'event']
        db.create_unique('importer_eventexternalcats', ['external_category_id', 'event_id'])
