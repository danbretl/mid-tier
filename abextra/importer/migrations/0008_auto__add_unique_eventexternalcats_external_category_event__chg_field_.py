...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegexCategory.source'
        db.alter_column('importer_regexcategory', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Source']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RegexCategory.source'
        db.alter_column('importer_regexcategory', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['events.Source']))
