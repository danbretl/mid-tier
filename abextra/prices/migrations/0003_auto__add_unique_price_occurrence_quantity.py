...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Price', fields ['occurrence', 'quantity']
        db.create_unique('prices_price', ['occurrence_id', 'quantity'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Price', fields ['occurrence', 'quantity']
        db.delete_unique('prices_price', ['occurrence_id', 'quantity'])
    ...
    models = {
        ...
        'events.event': {
            ...
            'search_vector': ('core.fields.VectorField', [], {'null': 'True'}),
        ...
        'events.occurrence': {
            'Meta': {'unique_together': "(('event', 'place', 'start_datetime'),)", 'object_name': 'Occurrence'},
        ...
        'places.place': {
            'Meta': {'ordering': "('title',)", 'unique_together': "(('title', 'point'),)", 'object_name': 'Place'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'prices.price': {
            'Meta': {'unique_together': "(('occurrence', 'quantity'),)", 'object_name': 'Price'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'occurrence': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prices'", 'to': "orm['events.Occurrence']"}),
            'quantity': ('django.db.models.fields.FloatField', [], {}),
            'remark': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'units': ('django.db.models.fields.CharField', [], {'default': "'dollars'", 'max_length': '300'})
        }
    }
