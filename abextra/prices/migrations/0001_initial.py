...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Price'
        db.create_table('prices_price', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('units', self.gf('django.db.models.fields.CharField')(default='dollars', max_length=300)),
            ('remark', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('occurrence', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prices', to=orm['events.Occurrence'])),
        ))
        db.send_create_signal('prices', ['Price'])


    def backwards(self, orm):
        
        # Deleting model 'Price'
        db.delete_table('prices_price')
