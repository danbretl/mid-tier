...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('behavior_eventaction', (
        ...
        db.create_table('behavior_eventactionaggregate', (
            ...
            ('g', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('v', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('i', self.gf('django.db.models.fields.IntegerField')(default=0)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EventActionAggregate'
        db.delete_table('behavior_eventactionaggregate')
