...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Point.geometry'
        db.add_column('places_point', 'geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Point.geometry'
        db.delete_column('places_point', 'geometry')
