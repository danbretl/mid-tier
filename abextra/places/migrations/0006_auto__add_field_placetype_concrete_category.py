...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaceType.concrete_category'
        db.add_column('places_placetype', 'concrete_category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='place_concrete', null=True, to=orm['events.Category']), keep_default=False)

        # Adding M2M table for field abstract_categories on 'PlaceType'
        db.create_table('places_placetype_abstract_categories', (
        ...
        db.create_unique('places_placetype_abstract_categories', ['placetype_id', 'category_id'])


    def backwards(self, orm):
        
        # Deleting field 'PlaceType.concrete_category'
        db.delete_column('places_placetype', 'concrete_category_id')

        # Removing M2M table for field abstract_categories on 'PlaceType'
        db.delete_table('places_placetype_abstract_categories')
    ...
    models = {
        ...
        'places.placetype': {
            ...
            'abstract_categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'place_abstract'", 'null': 'True', 'to': "orm['events.Category']"}),
            'concrete_category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'place_concrete'", 'null': 'True', 'to': "orm['events.Category']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
