...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Point.latitude'
        db.delete_column('places_point', 'latitude')

        # Deleting field 'Point.longitude'
        db.delete_column('places_point', 'longitude')

        # Changing field 'Point.geometry'
        db.alter_column('places_point', 'geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(default=None))


    def backwards(self, orm):
        
        # Adding field 'Point.latitude'
        db.add_column('places_point', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Point.longitude'
        db.add_column('places_point', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Changing field 'Point.geometry'
        db.alter_column('places_point', 'geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))
