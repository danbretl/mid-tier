...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('places_place_place_types', (
        ...
        db.create_unique('places_place_place_types', ['place_id', 'placetype_id'])
