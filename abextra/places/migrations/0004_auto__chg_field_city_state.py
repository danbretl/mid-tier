...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('places_city', 'state', self.gf('django.contrib.localflavor.us.models.USStateField')(max_length=2))


    def backwards(self, orm):
        
        # Changing field 'City.state'
        db.alter_column('places_city', 'state', self.gf('django.db.models.fields.CharField')(max_length=100))
