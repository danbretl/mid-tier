...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeviceUdid.user_anonymous'
        db.add_column('api_deviceudid', 'user_anonymous', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='device_udid_anonymous', unique=True, null=True, to=orm['auth.User']), keep_default=False)

        # Adding M2M table for field users on 'DeviceUdid'
        db.create_table('api_deviceudid_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('deviceudid', models.ForeignKey(orm['api.deviceudid'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('api_deviceudid_users', ['deviceudid_id', 'user_id'])


    def backwards(self, orm):
        
        # Deleting field 'DeviceUdid.user_anonymous'
        db.delete_column('api_deviceudid', 'user_anonymous_id')

        # Removing M2M table for field users on 'DeviceUdid'
        db.delete_table('api_deviceudid_users')
