...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlphaQuestionnaire.year_of_birth'
        db.add_column('alphasignup_alphaquestionnaire', 'year_of_birth', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 5, 10)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlphaQuestionnaire.year_of_birth'
        db.delete_column('alphasignup_alphaquestionnaire', 'year_of_birth')
    ...
    models = {
        ...
        'alphasignup.alphaquestionnaire': {
            ...
            'year_of_birth': ('django.db.models.fields.DateField', [], {}),
